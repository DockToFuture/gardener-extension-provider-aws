...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*IPAMControllerConfig)(nil), (*aws.IPAMControllerConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_IPAMControllerConfig_To_aws_IPAMControllerConfig(a.(*IPAMControllerConfig), b.(*aws.IPAMControllerConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*aws.IPAMControllerConfig)(nil), (*IPAMControllerConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_aws_IPAMControllerConfig_To_v1alpha1_IPAMControllerConfig(a.(*aws.IPAMControllerConfig), b.(*IPAMControllerConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ControlPlaneConfig_To_aws_ControlPlaneConfig(in *ControlPlaneConfig, out *aws.ControlPlaneConfig, s conversion.Scope) error {
	...
	out.IPAMController = (*aws.IPAMControllerConfig)(unsafe.Pointer(in.IPAMController))
...
func autoConvert_aws_ControlPlaneConfig_To_v1alpha1_ControlPlaneConfig(in *aws.ControlPlaneConfig, out *ControlPlaneConfig, s conversion.Scope) error {
	...
	out.IPAMController = (*IPAMControllerConfig)(unsafe.Pointer(in.IPAMController))
...
func autoConvert_v1alpha1_IPAMControllerConfig_To_aws_IPAMControllerConfig(in *IPAMControllerConfig, out *aws.IPAMControllerConfig, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_v1alpha1_IPAMControllerConfig_To_aws_IPAMControllerConfig is an autogenerated conversion function.
func Convert_v1alpha1_IPAMControllerConfig_To_aws_IPAMControllerConfig(in *IPAMControllerConfig, out *aws.IPAMControllerConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_IPAMControllerConfig_To_aws_IPAMControllerConfig(in, out, s)
}

func autoConvert_aws_IPAMControllerConfig_To_v1alpha1_IPAMControllerConfig(in *aws.IPAMControllerConfig, out *IPAMControllerConfig, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_aws_IPAMControllerConfig_To_v1alpha1_IPAMControllerConfig is an autogenerated conversion function.
func Convert_aws_IPAMControllerConfig_To_v1alpha1_IPAMControllerConfig(in *aws.IPAMControllerConfig, out *IPAMControllerConfig, s conversion.Scope) error {
	return autoConvert_aws_IPAMControllerConfig_To_v1alpha1_IPAMControllerConfig(in, out, s)
}
